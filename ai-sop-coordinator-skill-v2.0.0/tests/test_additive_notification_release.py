...
class AdditiveReleaseTests(unittest.TestCase):
    ...
    def test_release_metadata_is_v200_and_member_binding_is_v200(self):
    ...
    def test_previous_member_release_is_retained(self):
        self.assertTrue((REPO / "ai-sop-member-skill-v1.8.1" / "package-manifest.json").is_file())
