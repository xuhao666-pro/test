---
name: ai-sop-member
description: Use when a registered member executes a confirmed V1.8.1 assignment that requires exact Skill release binding, an explicit task-acceptance receipt, project-controlled AI dialogue collaboration, independent contribution boundaries, and final human owner confirmation.
---
...
8. 使用脚本检查精确 Skill 版本、协议、schema、身份、协作模型、轮次和基线。
