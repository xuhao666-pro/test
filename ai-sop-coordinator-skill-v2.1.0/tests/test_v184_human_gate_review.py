...
class ReleaseIdentityTests(unittest.TestCase):
    def test_release_identity_and_member_binding(self):
        ...
        self.assertEqual(
            runtimes["predevelopment"]["build_id"],
            "coordinator-cli-1.8.5-unified-member-package-v1",
        )
        self.assertEqual(runtimes["development_delivery"]["skill_version"], "2.0.0")
        self.assertEqual(
            runtimes["development_delivery"]["build_id"],
            "coordinator-dev-cli-2.0.0-v1",
        )
        ...
        self.assertEqual(
            requirements["development_delivery"]["build_id"],
