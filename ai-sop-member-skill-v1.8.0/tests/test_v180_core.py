...
PACKAGE = REPO / "ai-sop-member-skill-v1.8.0"
...
class V180MemberTests(unittest.TestCase):
    def test_release_identity_is_consistent(self):
        ...
        self.assertEqual(manifest["package_version"], "1.8.0")
        self.assertEqual(manifest["release_status"], "stable")
        self.assertEqual(protocol["skill_version"], "1.8.0")
        self.assertTrue(cli.BUILD_ID.startswith("member-cli-1.8.0-"))
    ...
    def test_exact_required_member_release_rejects_different_build(self):
        ...
        assignment = {
            ...
            "required_member_skill": {
                "name": "ai-sop-member",
                "version": "1.8.0",
                "build_id": "member-cli-1.8.0-other",
