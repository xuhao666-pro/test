...
V2.0 使用 `scripts/development_cli.py` 自动管理开发任务预览与确认、独立代码审查、精确 commit 的 main 可达性、G4、灰度记录和 G5。内置 V1.8.5 Coordinator CLI 管理 A—C 与 G1—G3，并从统一 Member 包发现精确的 `predevelopment` runtime。
