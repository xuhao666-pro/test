...
- The newest valid candidate is selected by package version while assignments retain the exact runtime version and build.
- Legacy flat manifests remain readable during migration, and historical no-control tasks remain bound to the V1.8.0 runtime profile.
